...
\section{Objective}
Utilize experience in energy flow modeling and multi-objective
optimization to solve challenging technical and economic problems that
improve the sustainability and robustness of the United States energy
and transportation system.
%
\section{Research Interests}
% maybe make this a list environment
developing fast running models of complex systems; multi-objective
(Pareto) optimization; multi-physics modeling; stochastic modeling of
physical and economic systems; assessing the impact of sensor dynamics
and frequency response; identifying and characterizing emergent
phenomena; collaborating with a diverse team of researchers and
stakeholders
%
