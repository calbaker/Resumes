...
%
mass, heat, and energy transport processes; combustion; electron microscopy; bulk
nanomaterial synthesis; catalyst optimization; heat exchanger
optimization; second law efficiency optimization, engineering education 
...
\item[] Ph.D.,
        \href{http://www.me.utexas.edu/}
             {Mechanical Engineering}, Expected Graduation: Aug 2012
        \begin{innerlist}        
        \item Adviser:%
...
\item[] M.S.,
        ...
        \begin{innerlist}
        \item Thesis Topic: \emph{Vapor Transport Techniques for Growing Macroscopically Uniform 
...
\begin{outerlist}
\item[] B.S.,
        \href{http://www.mengr.tamu.edu/}{Mechanical Engineering}, May 2007
\end{outerlist}
...
\begin{innerlist}
	\item Graded weekly assignments for ME 374C - Internal Combustion Engines
\end{innerlist}~
...
\begin{innerlist}
\item Planned and implemented machining processes to produce test billets from a raw round ingot.
...
\item[] \textit{Member}%
  \hfill 2008--2010
  \begin{innerlist}
  \item Assisted with GEC Energy Series lectures
  \item Assisted with Graduate and Industry Networking (GAIN) event
  \end{innerlist}~
\end{outerlist}
\blankline
...
General Service
\begin{innerlist}
\item Refereed for First Lego League competitions to encourage children to be interested in science and engineering
\item Donate blood quarterly
\end{innerlist}
...
Applications: Microsoft Office, Python, \href{http://www.mathworks.com/products/matlab/}{Matlab}, \LaTeX, LyX, Emacs, and other common productivity packages for Windows and Linux platforms

\blankline

\href{http://www.mathworks.com/products/matlab/}{\textsc{Matlab}}
experience: linear algebra, polynomials, stiff ODEs, vehicle dynamics modeling, combustion catalyst modeling, vapor deposition modeling
