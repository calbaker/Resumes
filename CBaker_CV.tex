...
% Again, the address lines must be centered over entire width of resume:
 \moveleft.5\hoffset\centerline{Curricula Vita}
...
\section{Objective}
Full-time or transitional part-time position utilizing skills in
modeling and python programming to solve challenging technical
problems and develop open source software.  

% Full-time position utilizing skills in modeling to improve
% understanding of mass, energy, heat, and momentum transport
% processes.  

\section{Programming Experience}
All Python modeling work is available at
\href{https://github.com/calbaker/}{https://github.com/calbaker/}
\begin{itemize} \itemsep -2pt
\item Thoroughly familiar with \href{http://numpy.scipy.org/}{NumPy} 
\item Familiar with numerous \href{http://www.scipy.org/}{SciPy}
  packages
\item Contributed to SciPy development
\item Contributed to other open source communities such as Linux,
  Cantera, and Ubuntu
\end{itemize} 
...
modeling; modeling financial systems
