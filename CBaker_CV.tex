...
\section{Objective}
Full-time position utilizing skills in computer modeling to solve
problems dealing with fluid flow, heat transfer, energy transfer, mass
transfer, and cash flow.  
...
Modeling mass, heat, and energy transport processes; applying
engineering principals to financial systems; developing open source
engineering and finance analysis tools; mastering new programming
skills
...
Flow, Internal Combustion Engines, Practical Electron Microscopy;
Engineering Economy
